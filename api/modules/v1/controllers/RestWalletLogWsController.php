...
use common\modelsMongo\WalletLogWs ;
use common\models\Order;
use Yii;
use yii\web\NotFoundHttpException;
use yii\web\ServerErrorHttpException;

class RestWalletLogWsController extends BaseApiController
{
    /** Role :
        case 'cms':
        case 'warehouse':
    ...
    **/
    ...
    {
        $response = WalletLogWs::search($params = '');
    ...
    public function actionCreate()
    {
        ...
        if (isset($_post) !== null) {
            ...
            $_rest_data = ["WalletLogWs" => [
                ...
                "LogTypWalletWs" =>  $_post['LogTypWalletWs'], // "Order hoăc Product", // LogType : Order | Product : and Id để join
    ...
    {
        if (($model = WalletLogWs::findOne($id)) !== null) {
            return $model;
        } else {
            Yii::$app->api->sendFailedResponse("Invalid Record requested");
        }
