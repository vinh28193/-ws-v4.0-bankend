...
use api\modules\v1\userbackend\controllers\OrderController;
use common\models\db\Actions;
use common\models\db\ActionScope;
use common\models\db\Scopes;
...
class AuthController extends RestController
{
    ...
    public function beforeAction($action)
    {
        ...
        if(isset($this->get['scope']) && $this->get['scope'] == "clear"){
            ...
            Yii::$app->cache->delete("Scopes_for_customer");
            Yii::$app->cache->delete('Scopes_for_user_id_'.$user_id);
        }
        ...
        $list_scope_user = $this->isCustomer() ? Yii::$app->cache->get('Scopes_for_customer') : Yii::$app->cache->get('Scopes_for_user_id_'.$user_id);
        if (!$list_scope_user) {
            if ($this->isCustomer()) {
                ...
                Yii::$app->cache->set('Scopes_for_customer', $list_scope_user, 60 * 60);
            } else {
                ...
                Yii::$app->cache->set('Scopes_for_user_id_' . $user_id, $list_scope_user, 60 * 60);
            }
        }
        $check = false;
        ...
        if(!$check){
         return $this->response(false,"You can not access! Pls contact with admin!",null,405);
        }
