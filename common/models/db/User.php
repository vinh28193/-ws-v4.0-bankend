 ...
 * @property int $vip_end_time Thời gian vip hết hạn
...
class User extends \common\components\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['username', 'password_hash', 'password_reset_token', 'email', 'first_name', 'last_name', 'phone', 'avatar', 'link_verify', 'verify_code_type', 'uuid', 'token_fcm', 'token_apn', 'client_id_ga', 'facebook_acc_kit_token', 'version', 'warehouse_code'], 'string', 'max' => 255],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'vip_end_time' => Yii::t('db', 'Vip End Time'),
            'pickup_id' => Yii::t('db', 'Pickup ID'),
            'warehouse_code' => Yii::t('db', 'Warehouse Code'),
        ];
    }
