...
class Order extends \common\components\db\ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'check_insurance' => Yii::t('db', 'Check Insurance'),
            'check_inspection' => Yii::t('db', 'Check Inspection'),
            'boxed_fee' => Yii::t('db', 'Boxed Fee'),
            'check_packing_wood' => Yii::t('db', 'Check Packing Wood'),
            'total_intl_shipping_fee_amount' => Yii::t('db', 'Total Intl Shipping Fee Amount'),
            'total_origin_tax_fee_amount' => Yii::t('db', 'Total Origin Tax Fee Amount'),
            'total_weshop_fee_amount' => Yii::t('db', 'Total Weshop Fee Amount'),
            'total_boxed_fee_amount' => Yii::t('db', 'Total Boxed Fee Amount'),
            'total_origin_shipping_fee_amount' => Yii::t('db', 'Total Origin Shipping Fee Amount'),
            'total_vat_amount_amount' => Yii::t('db', 'Total Vat Amount Amount'),
            'note_update_payment' => Yii::t('db', 'Note Update Payment'),
            'payment_provider' => Yii::t('db', 'Payment Provider'),
            'payment_method' => Yii::t('db', 'Payment Method'),
            'payment_bank' => Yii::t('db', 'Payment Bank'),
            'payment_transaction_code' => Yii::t('db', 'Payment Transaction Code'),
            'total_custom_fee_amount' => Yii::t('db', 'Total Custom Fee Amount'),
            'tracking_codes' => Yii::t('db', 'Tracking Codes'),
            'purchase_note' => Yii::t('db', 'Purchase Note'),
            'contacting' => Yii::t('db', 'Contacting'),
            'awaiting_payment' => Yii::t('db', 'Awaiting Payment'),
            'awaiting_confirm_purchase' => Yii::t('db', 'Awaiting Confirm Purchase'),
            'delivering' => Yii::t('db', 'Delivering'),
            'delivered' => Yii::t('db', 'Delivered'),
