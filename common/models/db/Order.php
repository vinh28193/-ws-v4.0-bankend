...
class Order extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['seller_store'], 'url'],
            [['note_by_customer', 'note', 'seller_store', 'purchase_amount', 'purchase_account_email', 'purchase_card',  'total_weight', 'total_weight_temporary'],'filter','filter' => '\yii\helpers\Html::encode'],
