...
class Order extends \common\components\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['note_by_customer', 'note', 'seller_store', 'purchase_order_id', 'purchase_transaction_id', 'purchase_account_id', 'purchase_account_email', 'purchase_card', 'purchase_refund_transaction_id', 'note_update_payment', 'tracking_codes'], 'string'],
