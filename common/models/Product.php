...
//        return parent::getOrderFee(); // TODO: Change the autogenerated stub
    ...
    {
        return $this->hasOne(OrderFee::className(), ['product_id' => 'id'])->where(['type' => 'SHIPPING_US']);
//        return parent::getOrderFee(); // TODO: Change the autogenerated stub
    }

    public function getUnitPrice()
    {
        return $this->hasOne(OrderFee::className(), ['product_id' => 'id'])->where(['type' => 'UNIT_PRICE']);
//        return parent::getOrderFee(); // TODO: Change the autogenerated stub
    }

    public function getUsTax()
    {
        return $this->hasOne(OrderFee::className(), ['product_id' => 'id'])->where(['type' => 'US_TAX']);
//        return parent::getOrderFee(); // TODO: Change the autogenerated stub
    }
}
