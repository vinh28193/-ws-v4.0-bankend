 ...
 * @property OrderFee $usShippingFee
 * @property OrderFee $unitPrice
 * @property OrderFee $usTax
...
//        return parent::getOrderFee(); // TODO: Change the autogenerated stub
    }

    public function getUsShippingFee()
    {
        return $this->hasOne(OrderFee::className(), ['product_id' => 'id'])->where(['type' => 'origin_shipping_fee']);
//        return parent::getOrderFee(); // TODO: Change the autogenerated stub
    }

    public function getUnitPrice()
    {
        return $this->hasOne(OrderFee::className(), ['product_id' => 'id'])->where(['type' => 'product_price_origin']);
//        return parent::getOrderFee(); // TODO: Change the autogenerated stub
    }

    public function getUsTax()
    {
        return $this->hasOne(OrderFee::className(), ['product_id' => 'id'])->where(['type' => 'tax_fee_origin']);
//        return parent::getOrderFee(); // TODO: Change the autogenerated stub
    }
