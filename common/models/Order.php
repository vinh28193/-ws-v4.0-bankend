...
class Order extends DbOrder implements RuleOwnerAccessInterface
{
    ...
    {
        return [
            [['store_id', 'type_order', 'customer_id', 'portal', 'receiver_email', 'receiver_name', 'receiver_phone', 'receiver_address', 'receiver_country_id', 'receiver_province_id', 'receiver_district_id', 'receiver_post_code', 'receiver_address_id', 'payment_type'], 'required', 'on' => self::SCENARIO_DEFAULT],
            [['receiver_post_code'], 'required', 'on' => self::SCENARIO_DEFAULT, 'when' => function ($model) {
                return $model->receiver_country_id = 2;
            }],
            [['current_status'], 'required', 'on' => self::SCENARIO_DEFAULT],
            [['current_status'], 'validateCurrentStatus', 'on' => self::SCENARIO_DEFAULT],
