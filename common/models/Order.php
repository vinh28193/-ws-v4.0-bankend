...
class Order extends DbOrder  // implements AdditionalFeeInterface
{
    ...
    public function rules()
    {
        return [
            ...
            [['type_order', 'portal', 'quotation_note', 'receiver_email', 'receiver_name', 'receiver_phone', 'receiver_address', 'receiver_country_name', 'receiver_province_name', 'receiver_district_name', 'receiver_post_code', 'payment_type', 'support_email', 'coupon_id', 'utm_source', 'seller_name', 'currency_purchase'], 'string', 'max' => 255],
