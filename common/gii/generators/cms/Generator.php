...
namespace common\gii\generators\cms;
...
class Generator extends \yii\gii\Generator
{
    ...
    public $db = 'db_cms';
    public $ns = 'common\models\db_cms';
    public $tableName;
    public $modelClass;
    ...
    public $queryNs = 'common\models\queries\cms';
    public $queryClass;
    ...
    {
        return 'This generator generates an ActiveRecord class for the specified cms database table.';
    }
