...
class BoxmeLogInspectionWs extends ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'LogTypeInspection'=> 'Order | Product | PACKEAGE | PACKEGEITEM', // LogType : Order | Product | PACKEAGE | PACKEGEITEM : and Id để join
            'id' => 'Id để join với LogTypeInspection ',

            'status' => 'Trạng thái nhãn kiểm : DONE , .....',
