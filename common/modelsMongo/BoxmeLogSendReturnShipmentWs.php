...
class BoxmeLogSendReturnShipmentWs extends ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'LogTypeSendShipmentReturn'=> 'Order | Product | PACKEAGE | PACKEGEITEM', // LogType : Order | Product | PACKEAGE | PACKEGEITEM : and Id để join
            'id' => 'Id để join với LogTypeSendShipmentReturn ',

            'status' => 'Trạng thái LogTypeSendShipmentReturn , .....',
