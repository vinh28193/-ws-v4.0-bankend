...
class m190320_124209_create_tracking_code_table extends Migration
{
    ...
    public function safeUp()
    {
        $this->createTable('tracking_code', [
            ...
            'tracking_code' => $this->string(60)->null()->comment('Tracking code'),
            'order_ids' => $this->integer(11)->null()->defaultValue(null)->comment('Order id(s)'),
            'weshop_tag' => $this->string(60)->null()->defaultValue(null)->comment("Weshop Tag"),
            'warehouse_alias' => $this->string(60)->null()->comment('warehouse alias BMVN_HN (Boxme Ha Noi/Boxme HCM)'),
            'warehouse_tag' => $this->string(60)->null()->comment('warehouse tag'),
            'warehouse_note' => $this->decimal(2)->defaultValue(0.00)->comment('warehouse note'),
