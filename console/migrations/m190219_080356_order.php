...
class m190219_080356_order extends Migration
{
    ...
    public function safeUp()
    {
        ...
        $this->createTable('order', [
            ...
            'coupon_id' => $this->bigInteger()->comment(" id mã giảm giá"),
...
//          'coupon_amount' => $this->decimal(18,2)->comment("số tiền áp dụng cho mã coupon này "),
            ...
            'promotion_id' => $this->bigInteger()->comment("id của promotion : Id Chạy chương trình promotion"),
...
//          'promotion_amount' => $this->decimal(18,2)->comment("số tiền áp dụng cho mã coupon này "),
            ...
            // Boxme + Kho
            'total_weight' => $this->integer(11)->comment("cân nặng tính phí"),
            'total_weight_temporary' => $this->integer(11)->comment("cân nặng tạm tính"),
            ...
            'purchase_account_id' => $this->text(11)->comment("id tài khoản mua hàng"),
