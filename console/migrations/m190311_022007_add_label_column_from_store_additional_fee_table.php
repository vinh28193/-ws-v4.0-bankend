...
class m190311_022007_add_label_column_from_store_additional_fee_table extends Migration
{
    ...
    public function safeUp()
    {
        ...
        $this->update('store_additional_fee',['label' => 'Giá gốc'],['name' => 'origin_fee']);
        $this->update('store_additional_fee',['label' => 'Phí US tax'],['name' => 'origin_tax_fee']);
        $this->update('store_additional_fee',['label' => 'phí vận chuyển tại US'],['name' => 'origin_shipping_fee']);
        ...
        $this->update('store_additional_fee',['label' => 'Custom'],['name' => 'custom_fee']);
        $this->update('store_additional_fee',['label' => 'Phí vận chuyển'],['name' => 'delivery_fee']);
        ...
        $this->update('store_additional_fee',['label' => 'Phí VAT'],['name' => 'vat_fee']);
    }
