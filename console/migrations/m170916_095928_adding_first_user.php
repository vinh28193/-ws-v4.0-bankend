...
class m170916_095928_adding_first_user extends Migration
{
    ...
    public function safeUp()
    {
        $sql="INSERT INTO `user` (`id`, `username`, `auth_key`, `password_hash`, `password_reset_token`, `email`, `status`, `created_at`, `updated_at`) VALUES
            (1, 'weshopgl', 'msYYcnCvsik9p-xXFh917VQ48fyzhtvR', '$2y$13$4M3N06yd6/sjwcKcal8PceB1nt.x6fJnxEx73iKZZV.tF1KPeILlO', 'mP4czGphDbp3waFgWSRyAPw5uBzgxmiQ_1429844420', 'weshopgl2019@gmail.com', 10, 1429844102, 1429846978);
            ";
