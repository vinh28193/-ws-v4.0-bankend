...
class m190606_041854_create_table_WS_DRAFT_MISSING_TRACKING extends Migration
{
    public function up()
    {
        $tableOptions = null;
        ...
        $this->createIndex('SYS_IL0000108660C00021$$', '{{%DRAFT_MISSING_TRACKING}}', '', true);
        $this->createIndex('SYS_IL0000108660C00023$$', '{{%DRAFT_MISSING_TRACKING}}', '', true);
    }
