!function (o) {
    ...
    o.zoom = function (n, t, e, i) {
        var c, u, a, m, s, r, l, f = o(n), h = f.css("position"), d = o(t);
        return f.css("position", /(absolute|fixed)/.test(h) ? h : "relative"), f.css("overflow", "hidden"), e.style.width = e.style.height = "", o(e).addClass("zoomImg").css({
            ...
            init: function () {
                ...
                var n = o.pageX - l.left, t = o.pageY - l.top;
                t = Math.max(Math.min(t, a), 0), n = Math.max(Math.min(n, m), 0), e.style.left = n * -s + "px", e.style.top = t * -r + "px"
            }
        }
    }, o.fn.zoom = function (t) {
        return this.each(function () {
            var e, i = o.extend({}, n, t || {}), c = i.target || this, u = this, a = o(u), m = o(c),
                s = document.createElement("img"), r = o(s), l = "mousemove.zoom", f = !1, h = !1;
            (i.url || ((e = a.find("img"))[0] && (i.url = e.data("src") || e.attr("src")), i.url)) && (!function () {
                var o = m.css("position"), n = m.css("overflow");
                a.one("zoom.destroy", function () {
                    a.off(".zoom"), m.css("position", o), m.css("overflow", n), r.remove()
                })
            }(), s.onload = function () {
                function n(n) {
                    e.init(), e.move(n), r.stop().fadeTo(o.support.opacity ? i.duration : 0, 1, !!o.isFunction(i.onZoomIn) && i.onZoomIn.call(s))
                }

                function t() {
                    r.stop().fadeTo(i.duration, 0, !!o.isFunction(i.onZoomOut) && i.onZoomOut.call(s))
                }
