<section id="style-4-container">
    <div class="container">
        <ul>
            <div class="row mkt-landing-flex">
                <li class="col-xs-12 col-sm-6 col-md-2 landing-mkt-6">
                ...
                <li class="col-xs-12 col-sm-6 col-md-2 landing-mkt-6">
                    <a href="<?php echo $images[5]['link'];?>">
                        <img class="img-responsive" src="<?php echo $images[5]['domain'].$images[5]['origin_src'];?>" alt="">
