    ...
    <div class="container">
        <ul>
            <div class="row mkt-landing-flex">
                <li class="col-xs-12 landing-mkt-6">
                ...
                <li class="col-md-3 col-sm-6 mrg-btm-30">
                ...
                <li class="col-md-3 col-sm-6 col-xs-12 col-6-xs-cfg landing-mkt-6">
                    ...
                    <a href="<?php echo $images[3]['link'];?>">
                        <img src="<?php echo $images[3]['domain'] . $images[3]['origin_src']; ?>" alt=""
                             class="img-responsive">
                    </a>
                </li>
                <li class="col-md-6 col-sm-12 landing-mkt-6">
