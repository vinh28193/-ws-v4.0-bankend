...
class ShippingForm extends Model
{
    ...
    public function rules()
    {
        ...
        return [
            ...
            [['buyer_district_id','receiver_district_id','buyer_address_id', 'receiver_address_id', 'customer_id', 'enable_buyer', 'enable_receiver', 'save_buyer_address', 'save_receiver_address'], 'safe']
        ];
    }
    ...
    public function getFirstErrors()
    {
        ...
        $errors = reset($errors);
        return $errors; // TODO: Change the autogenerated stub
    }
...
//        return $data;
    ...
    public function ensureReceiver()
    {
        ...
        if ($this->other_receiver === self::NO) {
