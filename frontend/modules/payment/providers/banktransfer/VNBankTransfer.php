...
class VNBankTransfer extends BaseObject implements PaymentProviderInterface
{
    ...
    public function create(Payment $payment)
    {
        ...
        return new PaymentResponse(true, 'create payment success','bankstransfervn', $payment->transaction_code, null,PaymentResponse::TYPE_REDIRECT, PaymentResponse::METHOD_GET, $summitUrl, $payment->return_url, $payment->cancel_url);
    }
