...
return [
    ...
    'rules' => [
        ...
        'ebay/seller/<seller:[^/]+>.html' => 'ebay/search/seller',
        'ebay/category/<name:[0-9a-zA-Z_-]+>-<id:\d+>.html' => 'ebay/search/category',
        ...
        'amazon/seller/<seller:[^/]+>.html' => 'amazon/search/seller',
        'amazon/category/<name:[0-9a-zA-Z_-]+>-<id:\d+>.html' => 'amazon/search/category',
        ...
        'amazon-jp/seller/<seller:[^/]+>.html' => 'amazon-jp/search/seller',
        'amazon-jp/category/<name:[0-9a-zA-Z_-]+>-<id:\d+>.html' => 'amazon-jp/search/category',
